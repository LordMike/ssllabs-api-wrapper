...
namespace given_that_I_make_a_info_request
{
    ...
    public class when_the_api_is_online : GenericPositiveTests<Info>
    {
        ...
        public static void Setup(TestContext testContext)
        {
            ...
            {
                Payloay =
                    "{\"engineVersion\":\"1.11.4\",\"criteriaVersion\":\"2009i\",\"clientMaxAssessments\":5,\"notice\":\"Some notice goes here\"}",
                StatusCode = 200,
    ...
    public class when_the_api_url_is_invalid : SharedNegativeTests
    {
        ...
        public static void Setup(TestContext testContext)
        {
            ...
            SSLLabsApiService ssllService = new SSLLabsApiService("https://blah-blah.dev.ssllabs.com/api/blah/",
                mockedApiProvider.Object);
            Response = ssllService.Info();
        }
    }
